...
namespace LessonsBg.Core.Data.Migrations
{
    ...
    [Migration("20221123133444_TrainingsAndTrainingTypesModifications")]
    partial class TrainingsAndTrainingTypesModifications
    {
            ...
            modelBuilder.Entity("LessonsBg.Core.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "2117ce8d-f1ba-4fce-bbd6-0847a0af3238",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "3aab70fb-4f85-4df5-b2bc-613a419fdf2d",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEBxcAsg8GYXke3eiIYZJrGp1sA+p9+onZIZ6Y1+pd4eMtLBjC0+0iJAcNSR2hFqBUA==",
                            PhoneNumber = "0891111111",
                            PhoneNumberConfirmed = true,
                            ProfileImage = "https://i.imgur.com/zqWjZFV.png",
                            SecurityStamp = "d49da9aa-8001-40ce-8416-32c6b8612506",
            ...
            modelBuilder.Entity("LessonsBg.Core.Data.Models.Subject", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9f1462fb-c31c-495a-94a1-0b556d6b0d57"),
                            Name = "Математика",
                            SubjectTypeId = 1
                        },
                        new
                        {
                            Id = new Guid("ffffb480-a18a-4f8c-8336-34463667f284"),
                            Name = "Български език",
                            SubjectTypeId = 2
                        },
                        new
                        {
                            Id = new Guid("8e7ef62e-3fdf-4fb9-9596-c687bf9b6a41"),
                            Name = "Английски език",
                            SubjectTypeId = 2
                        },
                        new
                        {
                            Id = new Guid("8091984d-1801-49fe-9d3f-d4c1fc4efdd0"),
            ...
            modelBuilder.Entity("LessonsBg.Core.Data.Models.Training", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1f07d801-f7a9-462a-806d-825efb2047b5"),
                            Name = "Карате",
                            TrainingTypeId = 1
                        },
                        new
                        {
                            Id = new Guid("8737a875-7f87-470a-8b87-f235c1aed97b"),
                            Name = "Кикбокс",
                            TrainingTypeId = 1
                        },
                        new
                        {
                            Id = new Guid("f9ebf29c-75a9-4701-a571-7abc3bf6eabc"),
                            Name = "Таекуондо",
                            TrainingTypeId = 1
                        },
                        new
                        {
                            Id = new Guid("196ff6c4-98ae-4c63-9dc6-9b495a722828"),
                            Name = "Баскетбол",
                            TrainingTypeId = 2
                        },
                        new
                        {
                            Id = new Guid("041294d0-fa69-45bc-ad57-759733ccce45"),
                            Name = "Футбол",
                            TrainingTypeId = 2
                        },
                        new
                        {
                            Id = new Guid("84c899ae-e5b0-47e1-bb53-002deee05baf"),
                            Name = "Волейбол",
                            TrainingTypeId = 2
                        });
                });
